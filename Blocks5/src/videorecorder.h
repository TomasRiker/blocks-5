...
// video, shine the audio and minimp4 writes the container, all three as
// source in libs/. Windows plays that combination without an extra codec
// since Windows 7, and the Linux build uses the same three libraries.
//
...
public:
	...
	// starts encoding the next frame; timecode counts frame periods since the
	// recording began
