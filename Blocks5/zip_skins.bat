REM zip_skins.bat [/optipng]
REM
REM /optipng runs Tools\optipng over each skin's PNGs first. It is off unless
REM asked for, and the argument is handled as in zip_data.bat, which says why
REM on both counts.
REM
